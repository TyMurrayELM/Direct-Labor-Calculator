...
export default function PropertiesPage() {
  ...
  const pageSize = 50; // Updated to match the DirectLaborCalculator
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 bg-gray-50 min-h-screen">
      <div className="bg-white shadow-xl rounded-xl overflow-hidden border border-gray-100">
        <div className="bg-gradient-to-r from-white to-gray-100 p-6 border-b border-gray-200">
          ...
          {/* Search Bar - Updated to use debounce */}
          <div className="mt-6">
              ...
              {searchQuery && (
                <button
                  onClick={() => {
                    ...
                    const inputElement = document.querySelector('input[placeholder="Search properties..."]');
                    if (inputElement) {
                      inputElement.value = '';
                    }
                  }}
                  ...
                  <tr>
                    <td colSpan="6" className="px-6 py-12 text-center text-gray-500">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-400 mt-1">{searchQuery ? "Try a different search term" : "Add a new property to get started"}</p>
                      </div>
                    </td>
                  </tr>
                ) : (
                  properties.map((property) => (
                    <tr key={property.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {getBranchName(property.branch_id)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
          ...
          <div className="flex items-center justify-between">
            <div className="hidden sm:block">
              <p className="text-sm text-gray-700">
                Showing <span className="font-medium">{properties.length}</span> of <span className="font-medium">{count}</span> properties
              </p>
            </div>
            <div className="flex items-center space-x-4">
              <button
                ...
                className={`px-4 py-2 rounded-lg flex items-center space-x-1 font-medium shadow-sm transition-colors ${page === 1 || loading ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-300'}`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg flex items-center space-x-1 font-medium shadow-sm transition-colors ${page === (totalPages || 1) || loading ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-300'}`}
              >
                <span>Next</span>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
