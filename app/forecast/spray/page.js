...
export default function SprayForecastPage() {
  ...
  // Fetch spray P&L metrics for current version and Original Forecast baseline
  const pnlBranchId = isPhoenixView ? phoenixBranchId : selectedBranchId;
  useEffect(() => {
    if (!pnlBranchId || !pnlVersionState || isEncoreView) { setCurrentMetrics(null); setBaselineMetrics(null); return; }
  ...
  const versionLabel = isEncoreView ? 'Encore' : isPhoenixView ? 'Phoenix' : (selectedBranch?.name || '');
        ...
        <div className="bg-gradient-to-r from-white to-gray-100 p-4 border-b border-gray-200"
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Spray Forecast</h1>
        ...
        {currentMetrics && (
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Annual Revenue */}
              {renderSummaryCard(
                'Annual Revenue', 'from-red-600 to-red-500',
