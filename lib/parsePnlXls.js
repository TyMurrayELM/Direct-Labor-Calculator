 ...
 * NetSuite exports may show "01" vs "1" inconsistently.
 *
 * Trailing zeros are PRESERVED — codes like "5105.1.10" are real sub-accounts
 * (e.g. Limelight Software vs Adobe at 5105.1.1) and must not collapse.
 *
 * Examples: "5101.01" → "5101.1", "5050.2.03" → "5050.2.3", "5105.1.10" → "5105.1.10"
 */
